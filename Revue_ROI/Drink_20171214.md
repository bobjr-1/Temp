...
## Vers un nouvel article 10a (suite du *brainstorming*) ?
...
* pour <font color="red">&#x2460; faciliter le stationnement et/ou le rangement pour les vélos</font> ;
...
* pour, de manière plus générale, <font color="red">&#x2461; faciliter l'accès de l'immeuble aux occupants</font>, qu'ils soient moins valides ou en très bas âge (poussettes)
...
* de faire en sorte que l'installation, puis la maintenance de ces nouvelles facilités soit aisément gérable et n'entraîne pas de frais insupportables pour les copropriétaires ;
